  ...
  return (
    <header className="fixed left-0 right-0 top-0 z-50 border-b border-white/[0.04] bg-surface/80 backdrop-blur-xl">
      <div className="mx-auto flex h-14 max-w-6xl items-center justify-between px-4 sm:px-6">
        <button onClick={handleHome} className="flex items-center gap-2.5 cursor-pointer group">
          ...
          <span className="text-base font-semibold text-white transition-colors group-hover:text-brand-400 sm:text-lg">
            {t("header.title")}
          </span>
        </button>
